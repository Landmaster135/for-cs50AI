...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people.keys():
        ...
        if people[person]["mother"] == None :
            ...
            if person in one_gene :
                if people[person]["mother"] in one_gene or  people[person]["father"] in one_gene:
                     p*=0.5
                     ...
                     if people[person]["father"] in two_genes:
                         ...
                         p*=((1-PROBS["mutation"])*(1-PROBS["mutation"])+PROBS["mutation"]*PROBS["mutation"])
                else:
                    ...
                    if people[person]["father"] in two_genes:
                        ...
                        p*=(1-PROBS["mutation"])*PROBS["mutation"]*2
                if person in have_trait:
                ...
                if people[person]["mother"] in one_gene:
                     if people[person]["father"] in one_gene:
                         ...
                         p*=0.5*(1-PROBS["mutation"])

                     else:
                         p*=0.5*PROBS["mutation"]
                elif people[person]["mother"] in two_genes:
                     if people[person]["father"] in one_gene:
                         p*=(1-PROBS["mutation"])*0.5
                     elif people[person]["father"] in two_genes:
...
def normalize(probabilities):
    ...
    """
    for person in probabilities.keys():
        g=probabilities[person]["gene"][1]+probabilities[person]["gene"][2]+probabilities[person]["gene"][0]
        t0=probabilities[person]["trait"][True]+probabilities[person]["trait"][False]
        probabilities[person]["gene"][1]/=g
        probabilities[person]["gene"][2]/=g
        probabilities[person]["gene"][0]/=g
        probabilities[person]["trait"][True]/=t0
        probabilities[person]["trait"][False]/=t0
